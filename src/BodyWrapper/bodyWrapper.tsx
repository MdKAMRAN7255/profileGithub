...
function BodyWrapper() {
    ...
    return ( 
        <>
            <div className='container text-light pt-5 pt-lg-0'>
                <div className='row g-0 d-flex flex-column flex-sm-row w-100 h-100'>
                    ...
                    <div className='col-10 col-sm-5 col-md-6 d-flex justify-content-sm-end h-100'>
